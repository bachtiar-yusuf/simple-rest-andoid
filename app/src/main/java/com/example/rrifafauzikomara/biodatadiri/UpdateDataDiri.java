...
public class UpdateDataDiri extends AppCompatActivity {
    ...
    private void getPesanan(){
        class GetPesanan extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("https://bachtiar110101.000webhostapp.com/simple-rest-android/web_service/Kesan/get_kesan.php?id=",id);
                return s;
            }
        }
    ...
    private void updatePesanan(){
        ...
        class UpdatePesanan extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("https://bachtiar110101.000webhostapp.com/simple-rest-android/web_service/Kesan/update_kesan.php", hashMap);
    ...
    private void deletePesanan(){
        class DeletePesanan extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("https://bachtiar110101.000webhostapp.com/simple-rest-android/web_service/delete_kesan.php?id=", id);
                return s;
            }
        }
